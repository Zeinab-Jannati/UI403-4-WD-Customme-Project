...
const UserProfile = () => {
    ...
    return ( 
        <>
            <MainMenu />
            <div className='flex justify-center sm:mt-[2rem] h-auto'>
                <div className='w-full sm:w-full flex flex-col sm:flex-row sm:gap-[1.5625rem] h-auto sm:p-[1.5rem]'>
                    <div className='flex justify-center'>
                        <ProfileSidebar/>
                    </div>
                    <hr className='sm:hiddne border-[var(--color-custome-gray-3)] border-[1px]' />
                    <div className='w-full sm:w-[50.5rem] h-auto border border-[var(--color-custome-gray-3)] rounded-[16px] p-[1.5rem] sm:mt-[4.0625rem] mb-[3.75rem] overflow-x-hidden'>
                        <h2 className='font-bold text-[1.125rem] sm:text-2xl'>سفارشات من</h2>
                        <OrderSummary />
                        <hr className='sm:hiddne border-[var(--color-custome-gray-3)] border-[1px]' />
                        <div className='border-b border-[var(--color-custome-gray-3)] pb-[1.5rem] w-full'>
                            <span className='flex justify-between items-center my-[1.5rem]'>
                                <h2 className='font-bold text-[1.125rem] sm:text-2xl'>علاقه مندی های من</h2>
                                <a href="#" className='w-[8rem] h-[2.5rem] text-[0.875rem] text-[var(--color-primary)] flex items-center justify-center'>مشاهده بیشتر</a>
                            </span>
                            ...
                            <div className='relative w-full flex sm:justify-center mt-[1.5rem] mb-[2.5rem]'>
                                <div className='w-[9.5rem] sm:w-[76.5rem] h-auto flex sm:flex-wrap gap-[0.5rem] sm:gap-[1.5rem]'>
                        ...
                        <div className='border-b border-[var(--color-custome-gray-3)] pb-[1.5rem]'>
                            <span className='flex justify-between items-center my-[1.5rem]'>
                                <h2 className='font-bold text-2xl text-[1.125rem] sm:text-2xl'>خرید های پرتکرار من </h2>
                                <a href="#" className='w-[8rem] h-[2.5rem] text-[0.875rem] text-[var(--color-primary)] flex items-center justify-center'>مشاهده بیشتر</a>
                            </span>
                        ...
                        <div>
                            <span className='flex justify-between items-center my-[1.5rem]'>
                                <h2 className='font-bold text-2xl text-[1.125rem] sm:text-2xl'>گالری من</h2>
                                <a href="#" className='w-[8rem] h-[2.5rem] text-[0.875rem] text-[var(--color-primary)] flex items-center justify-center'>مشاهده بیشتر</a>
                            </span>
                            <div className='flex gap-[1rem] relative'>
                                <ProductCard imageUrl={ productPic } productName="استیکر فرندز" productDescription="دارای رنگ بندی، قابل طراحی" price="۱۵۰,۰۰۰" />
            ...
            <Footer special="hidden sm:block" />
        </>
     );
}
